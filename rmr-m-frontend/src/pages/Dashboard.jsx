...
const POOL_CONTRACT_ADDRESS = "0xD810B6d225092409EBbB47abA7ad1edea161D60C"; // Adresse du pool LPFraming
...
const Dashboard = () => {
  ...
  const handleWithdrawEarnings = async () => {
    if (availableForWithdrawal > 1) {
      addStatus(`⚠️ Le minimum pour retirer est de 1 ${usdcSymbol}.`);
      return;
    }
