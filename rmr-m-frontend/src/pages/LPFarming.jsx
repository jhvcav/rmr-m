...
const LPFarming = () => {
  ...
  useEffect(() => {
    if (provider && account) {
      ...
      const contractAddress = "0xD810B6d225092409EBbB47abA7ad1edea161D60C"; // Adresse du LPFarming
  ...
  const goToDepotForm = () => {
    ...
    // Adresse du pool LPFarming
    const poolAddress = contract ? contract.address : "0xD810B6d225092409EBbB47abA7ad1edea161D60C";
