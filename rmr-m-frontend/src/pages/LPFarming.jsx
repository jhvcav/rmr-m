...
const LPFarming = () => {
  ...
  useEffect(() => {
    if (provider && account) {
      ...
      const contractAddress = "0x405412D71847eCb8Fa5a98A1F91B90b1231A93dc"; // Adresse du LPFarming
  ...
  const goToDepotForm = () => {
    ...
    const poolAddress = contract ? contract.address : "0x405412D71847eCb8Fa5a98A1F91B90b1231A93dc";
